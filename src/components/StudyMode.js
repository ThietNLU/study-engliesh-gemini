    ...
    <div className="bg-white rounded-xl shadow-xl p-8 mb-6">
      <div className="text-center mb-6">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center space-x-2">
            ...
            <span className={`text-sm px-3 py-1 rounded-full ${
              currentWord.level === 'beginner' ? 'bg-green-100 text-green-700' :
              currentWord.level === 'intermediate' ? 'bg-yellow-100 text-yellow-700' :
        ...
        <div className="mb-6 p-4 bg-green-50 rounded-lg">
          <h3 className="text-lg font-semibold text-green-700 mb-2">Nghĩa tiếng Việt</h3>
        ...
        {currentWord.definition && (
          <div className="mb-6 p-4 bg-blue-50 rounded-lg">
            <h3 className="text-lg font-semibold text-blue-700 mb-2">Định nghĩa</h3>
        ...
        {currentWord.example && (
          <div className="mb-6 p-4 bg-purple-50 rounded-lg">
            <h3 className="text-lg font-semibold text-purple-700 mb-2">Ví dụ</h3>
