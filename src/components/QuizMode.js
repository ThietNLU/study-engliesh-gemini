        ...
        {!showAnswer ? (
          ...
          <div className="mb-4">
            ...
            <div className="text-left max-w-md mx-auto p-4 bg-gray-50 rounded-lg">
              <p><strong>Đáp án:</strong> {quizType === 'meaning' ? currentWord.vietnamese : currentWord.english}</p>
              <p><strong>Phát âm:</strong> {accent === 'us' ? currentWord.pronunciation_us : currentWord.pronunciation_uk}</p>
              {currentWord.definition && <p><strong>Định nghĩa:</strong> {currentWord.definition}</p>}
            </div>
            <button
              onClick={nextCard}
