  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-3">Chào mừng đến với English Vocabulary!</h2>
        <p className="text-gray-600 mb-8 text-lg">Bắt đầu hành trình học từ vựng tiếng Anh của bạn ngay hôm nay</p>
        ...
        <p className="text-sm text-gray-500 mt-6">
          💡 Mẹo: Bạn có thể sử dụng AI để tạo danh sách từ vựng theo chủ đề yêu thích
        </p>
      </div>
    </div>
  );
