              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    ...
                    <span className="ml-1">{testingApi ? 'Đang test...' : 'Test API'}</span>
                  </button>
                </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">💡 Gợi ý yêu cầu:</h4>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            <h4 className="font-semibold text-green-800 mb-2">📊 Thống kê hiện tại:</h4>
            <ul className="text-sm text-green-700 space-y-1">
              <li>• Tổng từ vựng: {vocabulary.length}</li>
              <li>• Cơ bản: {vocabulary.filter(w => w.level === 'beginner').length}</li>
              <li>• Trung cấp: {vocabulary.filter(w => w.level === 'intermediate').length}</li>
              <li>• Nâng cao: {vocabulary.filter(w => w.level === 'advanced').length}</li>
            </ul>
          </div>
        </div>
