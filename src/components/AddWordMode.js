...
const AddWordMode = ({ newWord, setNewWord, addNewWord }) => {
  return (
    <div className="bg-white rounded-xl shadow-xl p-8 mb-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Thêm từ vựng mới</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setNewWord({...newWord, pronunciation_us: e.target.value})}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setNewWord({...newWord, pronunciation_uk: e.target.value})}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
