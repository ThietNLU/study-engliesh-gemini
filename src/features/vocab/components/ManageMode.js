            ...
            {editingWord === word.id ? (
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <input
                  ...
                  value={word.english}
                  onChange={e =>
                    handleWordChange(word.id, 'english', e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={e =>
                    handleWordChange(word.id, 'vietnamese', e.target.value)
                  }
                  className='px-3 py-2 border border-gray-300 rounded-lg'
                />
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex items-center space-x-4 mt-2 text-sm text-gray-600'>
                    <span className='bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-800 px-2 py-1 rounded flex items-center'>
                      {getCategoryInfo(word.category, categories).icon}{' '}
                      {getCategoryInfo(word.category, categories).name}
                    </span>
                    <span
