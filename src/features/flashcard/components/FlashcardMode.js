...
const FlashcardMode = () => {
  ...
  const handleCardReview = async (rating) => {
    ...
    const timeTaken = reviewStartTime ? Math.round((Date.now() - reviewStartTime) / 1000) : null;
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-4xl">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Flashcard Study</h1>
        <p className="text-gray-600">Spaced repetition learning with SM-2 algorithm</p>
      </div>
      ...
      {!sessionStarted ? (
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <select
                ...
                onChange={(e) => setStudyFilters({...studyFilters, category: e.target.value})}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setStudyFilters({...studyFilters, level: e.target.value})}
                className="w-full p-2 border rounded-lg"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setStudyFilters({...studyFilters, status: e.target.value})}
                className="w-full p-2 border rounded-lg"
              >
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Max Cards</label>
              <select
                value={studyFilters.maxCards}
                onChange={(e) => setStudyFilters({...studyFilters, maxCards: parseInt(e.target.value)})}
                className="w-full p-2 border rounded-lg"
              >
          ...
          <div className="flex justify-center">
            ...
            >
              {cardStats.due === 0 ? 'No Cards Due' : `Start Session (${cardStats.due} due)`}
            </button>
          </div>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="flex justify-between items-center">
              <div className="text-sm text-gray-600">
                Card {studySession.completedCards + 1} of {studySession.currentSessionCards.length}
              </div>
              <div className="text-sm text-gray-600">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      >
                        ...
                        <div className="text-xs opacity-80">
                          {Math.round(currentCard.interval * (currentCard.easeFactor || 2.5))}d
                        </div>
                      </button>
                      <button
                      ...
                      >
                        ...
                        <div className="text-xs opacity-80">
                          {Math.round(currentCard.interval * (currentCard.easeFactor || 2.5) * 1.3)}d
                        </div>
                      </button>
                    </div>
                    ...
                    <div className="text-xs text-gray-500 text-center">
                      ...
                      Ease: {(currentCard.easeFactor || 2.5).toFixed(1)} | 
                      Reviews: {currentCard.totalReviews || 0}
                    </div>
                  </div>
                )}
              </div>
